...
interface DocumentCardProps {
  document: Document;       // The document metadata to display
  onPress: () => void;      // Called when user taps the card body
  onDelete: () => void;     // Called when user taps the delete button
}
 ...
 */
const DocumentCard: React.FC<DocumentCardProps> = ({ document, onPress, onDelete }) => {
  return (
    /*
