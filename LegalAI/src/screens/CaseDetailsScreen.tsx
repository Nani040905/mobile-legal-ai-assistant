...
import useCaseStore, { CaseStatus } from '../store/useCaseStore';
import useDocumentStore from '../store/useDocumentStore';
import { CASE_TYPE_LABELS } from '../types/caseType';
import { COLORS, FONTS, SPACING, RADIUS } from '../utils/theme';
import { STATUS_LABELS, STATUS_COLORS } from './CasesScreen';

type RoutePropType = RouteProp<RootStackParamList, 'CaseDetails'>;
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'CaseDetails'>;
...
const CaseDetailsScreen: React.FC = () => {
  ...
  const handleUpdateField = (field: 'court' | 'judgeName' | 'nextHearingDate', value: string) => {
  ...
  const handleUnlinkDocument = (docId: string, docName: string) => {
    Alert.alert(
      'Unlink Document',
