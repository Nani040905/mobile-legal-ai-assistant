...
const TILES = [
  {
    ...
    title: 'Chat',
    icon: '💬',
    route: 'Chat' as const,            // "as const" narrows the type from string to literal 'Chat'
  ...
  },
  {
    ...
    title: 'Documents',
    icon: '📄',
    route: 'Documents' as const,       // Literal type ensures type-safe navigation
  ...
  },
  {
    ...
    title: 'Settings',
    icon: '⚙️',
    route: 'Settings' as const,        // Literal type for the Settings route
