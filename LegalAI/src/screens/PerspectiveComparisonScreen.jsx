...
import { comparePerspectives } from '../services/perspectiveComparison';
...
const PerspectiveComparisonScreen = () => {
  ...
  // Selector states
  const [perspectiveA, setPerspectiveA] = useState('plaintiff');
  const [perspectiveB, setPerspectiveB] = useState('defendant');
