...
import { search, ScoredChunk } from '../services/retrievalService';
...
const DebugRetrievalScreen: React.FC = () => {
  ...
  const renderResultItem = ({ item, index }: { item: ScoredChunk; index: number }) => {
