...
export interface ModelComparisonResult {
  ...
  hallucinationScore: number | null; // (1 - confidence) * 100
  accuracyScore: number | null;      // % of answers containing expected text
}
...
export const runModelComparison = async (
  ...
  const testQuestions = (benchmarkQuestions as any[]).slice(0, 3);
