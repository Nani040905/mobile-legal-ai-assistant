...
export type RootStackParamList = {
  Home: undefined;            // No params needed — it's the root screen
  Chat: undefined;            // No params — chat state lives in Zustand store
  Documents: undefined;       // No params — document list comes from Zustand store
  DocumentDetails: {          // Requires the document ID and name to display
