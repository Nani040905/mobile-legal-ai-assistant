...
const getSimulatedText = (fileUri) => {
 ...
 */
export const extractText = async (fileUri) => {
  try {
...
chunkSize = CHUNK_SIZE // Max chars per chunk (default 1000)
) => {
 ...
 */
export const getFileInfo = (fileUri, fileName) => {
  return {
